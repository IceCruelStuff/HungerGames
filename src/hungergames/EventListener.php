	...
	public function onInteract(PlayerInteractEvent $e) {
		...
		if ($b instanceof Sign) {
			if ($this->HGApi->getSignManager()->isGameSign($b)) {
				...
				if ($this->HGApi->getStorage()->isPlayerSet($p) || $this->HGApi->getStorage()->isPlayerWaiting($p)) {
					return;
				}
				if (
					$this->HGApi->getGlobalManager()->getGameManager($game)->getStatus() === "running" ||
					$this->HGApi->getGlobalManager()->getGameManager($game)->getStatus() === "reset"
				) {
					return;
				}
